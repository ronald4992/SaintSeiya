...
const knights = [
  // Bronce
  { id: 1, name: "Seiya", rank: "Bronce", constellation: "Pegaso", image: "https://caballeros-del-zodiaco.fandom.com/es/wiki/Seiya?file=Seiya.jpg", short_description: "Valiente caballero de Pegaso que lucha por Atena.", abilities: ["Meteoros de Pegaso", "Cometa de Pegaso"] },
  { id: 2, name: "Shiryu", rank: "Bronce", constellation: "Dragón", image: "https://caballeros-del-zodiaco.fandom.com/es/wiki/Shiryu?file=Shiryu.jpg", short_description: "Caballero del Dragón, leal y sabio.", abilities: ["Cólera del Dragón", "Último Dragón"] },
  { id: 3, name: "Hyoga", rank: "Bronce", constellation: "Cisne", image: "https://caballeros-del-zodiaco.fandom.com/es/wiki/Hyoga?file=Hyoga.jpg", short_description: "Guerrero del frío, nacido en Siberia.", abilities: ["Polvo de Diamantes", "Ataque Aurora"] },
  { id: 4, name: "Shun", rank: "Bronce", constellation: "Andrómeda", image: "https://caballeros-del-zodiaco.fandom.com/es/wiki/Shun?file=Shun.jpg", short_description: "De gran corazón, lucha con sus cadenas de Andrómeda.", abilities: ["Cadena Nebular", "Torbellino Nebular"] },
  { id: 5, name: "Ikki", rank: "Bronce", constellation: "Fénix", image: "https://caballeros-del-zodiaco.fandom.com/es/wiki/Ikki?file=Ikki.jpg", short_description: "Hermano mayor de Shun, renace de sus cenizas.", abilities: ["Ave Fénix", "Ilusión Diabólica del Fénix"] },

  // Plata
  { id: 6, name: "Marin", rank: "Plata", constellation: "Águila", image: "https://caballeros-del-zodiaco.fandom.com/es/wiki/Marin?file=Mar%C3%ADn.jpg", short_description: "Maestra de Seiya, caballero de la constelación del Águila.", abilities: ["Golpe de Águila", "Ilusión Celeste"] },
  { id: 7, name: "Shaina", rank: "Plata", constellation: "Ofiuco", image: "https://caballeros-del-zodiaco.fandom.com/es/wiki/Shaina?file=Shaina.jpg", short_description: "Guerrera temible, protectora del Santuario.", abilities: ["Garrote de Ofiuco", "Ataque de Serpiente"] },

  // Oro
  { id: 8, name: "Mu", rank: "Oro", constellation: "Aries", image: "https://caballeros-del-zodiaco.fandom.com/es/wiki/Mu?file=Mu.jpg", short_description: "Caballero de Aries, experto en reparación de armaduras.", abilities: ["Muro de Cristal", "Extinción de Luz Estelar"] },
  { id: 9, name: "Aldebarán", rank: "Oro", constellation: "Tauro", image: "https://caballeros-del-zodiaco.fandom.com/es/wiki/Aldebaran?file=Aldebar%C3%A1n.jpg", short_description: "Gigante noble y protector del Templo de Tauro.", abilities: ["Gran Cuerno", "Golpe de Toro"] },
